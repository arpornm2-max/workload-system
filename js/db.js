...
const DB = {
    async init() {
        try {
            ...
            // Migration: Bulk update teachers
            if (!localStorage.getItem('force_teacher_update_v1')) {
                console.log("Running teacher bulk update...");
                const allTeachers = [
    {
        "id": "t001",
        "username": "t001",
    ...
    },
    {
        ...
        "role": "admin"
                ...
                localStorage.setItem('force_teacher_update_v1', 'true');
                console.log("Teacher bulk update completed.");
            }
